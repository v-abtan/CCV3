...
function GrantAdminConsent {
    ...
    $confirmationQuestion = "Do you want to proceed?"
    $confirmationChoices = "&Yes", "&No" # 0 = Yes, 1 = No
    $consentErrorMessage = "Current user does not have the privilege to consent the `"User.Read`" permission on this app. Please ask your tenant's global administrator to consent."
